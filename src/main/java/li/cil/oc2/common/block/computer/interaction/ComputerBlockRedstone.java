...
public final class ComputerBlockRedstone {
    public static int getSignal(final BlockGetter blockGetter, final BlockPos pos, final Direction side) {
    ...
    public static void neighborChanged(final Level level, final BlockPos pos) {
        final BlockEntity blockEntity = level.getBlockEntity(pos);
        if (blockEntity instanceof final ComputerBlockEntity computer) {
            computer.terminalManager.handleNeighborChanged();
        }
    }
}