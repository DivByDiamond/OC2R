...
public final class RobotSerializer {
    ...
    public static void save(final Robot robot, final CompoundTag tag) {
        ...
        robot.getRobotInventory().saveItems(provider, NBTUtils.getOrCreateChildTag(tag, ITEMS_TAG_NAME));
        ...
        tag.put(INVENTORY_TAG_NAME, robot.getRobotInventory().getInventory().serializeNBT(provider));
    ...
    public static void load(final Robot robot, final CompoundTag tag) {
        ...
        robot.getRobotInventory().getInventory().deserializeNBT(provider, tag.getCompound(INVENTORY_TAG_NAME));
    ...
    public static void exportToItemStack(final Robot robot, final ItemStack stack) {
        ...
        CustomData.update(DataComponents.CUSTOM_DATA, stack, (nbt) -> {
            ...
            tag.put(ENERGY_TAG_NAME, robot.getEnergyStorage().serializeNBT(robot.registryAccess()));
        });
    }
    ...
    public static void importFromItemStack(final Robot robot, final ItemStack stack) {
        ...
        if (container != null) {
            ...
            robot.getRobotInventory().getInventory().deserializeNBT(provider, itemsTag.getCompound(INVENTORY_TAG_NAME));
        }
        robot.getEnergyStorage().deserializeNBT(provider, NBTUtils.getChildTag(stack, MOD_TAG_NAME, ENERGY_TAG_NAME));
    }
}
