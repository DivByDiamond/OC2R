...
public final class Constants {
    ...
    public static final int CPU_FREQUENCY = 50_000_000;
    ...
    public static final String TOOLTIP_DEVICE_NEEDS_REBOOT =
            key("tooltip.{mod}.device_needs_reboot");
    ...
    public static final String TOOLTIP_INTERNET_ENERGY_PER_PACKET =
            key("tooltip.{mod}.internet.energy_per_packet");

    public static final String TERMINAL_CAPTURE_INPUT_CAPTION =
            key("gui.{mod}.computer.capture_input.capt");
    public static final String TERMINAL_CAPTURE_INPUT_DESCRIPTION =
            key("gui.{mod}.computer.capture_input.desc");
    public static final String COMPUTER_SCREEN_POWER_CAPTION = key("gui.{mod}.computer.power.capt");
    public static final String COMPUTER_SCREEN_POWER_DESCRIPTION =
            key("gui.{mod}.computer.power.desc");
    public static final String COMPUTER_ERROR_UNKNOWN = key("gui.{mod}.computer.error.unknown");
    public static final String COMPUTER_ERROR_MISSING_FIRMWARE =
            key("gui.{mod}.computer.error.missing_firmware");
    public static final String COMPUTER_ERROR_MISSING_CPU =
            key("gui.{mod}.computer.error.missing_cpu");
    public static final String COMPUTER_ERROR_INSUFFICIENT_MEMORY =
            key("gui.{mod}.computer.error.insufficient_memory");
    public static final String COMPUTER_BUS_STATE_INCOMPLETE =
            key("gui.{mod}.computer.bus_state.incomplete");
    public static final String COMPUTER_BUS_STATE_TOO_COMPLEX =
    ...
    public static final String MACHINE_OPEN_TERMINAL_CAPTION =
            key("gui.{mod}.machine.open_terminal.capt");

    public static final String CONNECTOR_ERROR_FULL = key("message.{mod}.connector.error.full");
    public static final String CONNECTOR_ERROR_TOO_FAR =
