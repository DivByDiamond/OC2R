        ...
        player.openMenu(
                new MenuProvider() {
                    ...
                    public AbstractContainerMenu createMenu(
                        ...
                        return new RobotTerminalContainer(
                                id, player, robot, createEnergyInfo(energy, busController));
                    }
                },
                b -> b.writeVarInt(robot.getId()));
    }

    public static RobotTerminalContainer createClient(
        ...
        if (entity instanceof final Robot robot) {
            return new RobotTerminalContainer(
                    id, inventory.player, robot, createClientEnergyInfo());
        }

        throw new IllegalArgumentException();
    }

    private RobotTerminalContainer(
            final int id,
            final Player player,
            final Robot robot,
