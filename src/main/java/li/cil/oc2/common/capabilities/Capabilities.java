...
public final class Capabilities {
    public static final class DeviceBusElement {
        public static final BlockCapability<
                        li.cil.oc2.api.bus.DeviceBusElement, @Nullable Direction>
                BLOCK =
                        BlockCapability.createSided(
                                ResourceLocation.fromNamespaceAndPath(
                                        API.MOD_ID, "device_bus_element"),
                                li.cil.oc2.api.bus.DeviceBusElement.class);
    }

    public static final class Device {
        public static final BlockCapability<li.cil.oc2.api.bus.device.Device, @Nullable Direction>
                BLOCK =
                        BlockCapability.createSided(
                                ResourceLocation.fromNamespaceAndPath(API.MOD_ID, "device"),
                                li.cil.oc2.api.bus.device.Device.class);
        public static final ItemCapability<li.cil.oc2.api.bus.device.Device, @Nullable Void> ITEM =
    ...
    public static final class RedstoneEmitter {
        public static final BlockCapability<
                        li.cil.oc2.api.capabilities.RedstoneEmitter, @Nullable Direction>
                BLOCK =
                        BlockCapability.createSided(
                                ResourceLocation.fromNamespaceAndPath(
                                        API.MOD_ID, "redstone_emitter"),
                                li.cil.oc2.api.capabilities.RedstoneEmitter.class);
    }

    public static final class NetworkInterface {
        public static final BlockCapability<
                        li.cil.oc2.api.capabilities.NetworkInterface, @Nullable Direction>
                BLOCK =
                        BlockCapability.createSided(
                                ResourceLocation.fromNamespaceAndPath(
                                        API.MOD_ID, "network_interface"),
                                li.cil.oc2.api.capabilities.NetworkInterface.class);
    }

    public static final class TerminalUserProvider {
        public static final BlockCapability<
                        li.cil.oc2.api.capabilities.TerminalUserProvider, @Nullable Void>
                BLOCK =
                        BlockCapability.createVoid(
                                ResourceLocation.fromNamespaceAndPath(
                                        API.MOD_ID, "terminal_user_provider"),
    ...
    public static final class Robot {
        public static final EntityCapability<li.cil.oc2.api.capabilities.Robot, @Nullable Void>
                ENTITY =
                        EntityCapability.createVoid(
                                ResourceLocation.fromNamespaceAndPath(API.MOD_ID, "robot"),
