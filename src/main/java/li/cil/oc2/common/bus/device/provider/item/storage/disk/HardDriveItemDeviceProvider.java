package li.cil.oc2.common.bus.device.provider.item.storage.disk;
...
import li.cil.oc2.common.bus.device.vm.item.storage.HardDriveDevice;
    ...
    protected Optional<ItemDevice> getItemDevice(final ItemDeviceQuery query) {
        return Optional.of(
                new HardDriveDevice(
                        ...
                        getCapacity(query),
                        false,
                        LocationSupplierUtils.of(query)));
    }
