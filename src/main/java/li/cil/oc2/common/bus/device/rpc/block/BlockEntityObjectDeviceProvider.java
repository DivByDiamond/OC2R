...
public final class BlockEntityObjectDeviceProvider
        extends AbstractBlockEntityDeviceProvider<BlockEntity> {
    @Override
    public Optional<Device> getBlockDevice(
            final BlockDeviceQuery query, final BlockEntity blockEntity) {
