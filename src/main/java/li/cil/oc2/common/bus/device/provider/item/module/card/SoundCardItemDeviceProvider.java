package li.cil.oc2.common.bus.device.provider.item.module.card;

import java.util.Optional;
import li.cil.oc2.api.bus.device.ItemDevice;
import li.cil.oc2.api.bus.device.provider.ItemDeviceQuery;
import li.cil.oc2.common.bus.device.provider.util.AbstractItemDeviceProvider;
import li.cil.oc2.common.bus.device.rpc.item.card.SoundCardItemDevice;
...
public final class SoundCardItemDeviceProvider extends AbstractItemDeviceProvider {
    ...
    protected Optional<ItemDevice> getItemDevice(final ItemDeviceQuery query) {
        return Optional.of(
                new SoundCardItemDevice(query.getItemStack(), LocationSupplierUtils.of(query)));
    }
