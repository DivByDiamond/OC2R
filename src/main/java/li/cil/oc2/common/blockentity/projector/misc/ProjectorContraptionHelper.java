...
public final class ProjectorContraptionHelper {
    ...
    @Nullable
    public static ProjectorBlockEntity getPrimaryForContraptionRendering(
    ...
    public static void registerInClientRegistry(final ProjectorBlockEntity projector) {
    ...
    public static void unregisterFromClientRegistry(final ProjectorBlockEntity projector) {
        final var level = projector.getLevel();
        if (level == null || !level.isClientSide()) {
            return;
        }
