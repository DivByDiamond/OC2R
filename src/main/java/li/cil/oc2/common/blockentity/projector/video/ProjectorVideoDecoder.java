...
public final class ProjectorVideoDecoder {
    ...
    public void setFrameConsumer(final Picture picture, @Nullable final FrameConsumer consumer) {
    ...
    public void applyNextFrameClient(final Picture picture, final ByteBuffer frameData) {
