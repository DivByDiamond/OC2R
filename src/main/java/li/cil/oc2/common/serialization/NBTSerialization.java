...
/**
 * Utility for serializing/deserializing arbitrary objects to/from NBT
 * using Ceres serialization framework.
 * <p>
 * Supports primitive types, enums, arrays, UUIDs, and complex objects
 * registered with Ceres serializers.
 */
