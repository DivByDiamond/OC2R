...
public class ColorModeSerializer implements Serializer<TerminalColors.ColorMode> {
    ...
    @Override
    public void serialize(final SerializationVisitor serializationVisitor, final Class<TerminalColors.ColorMode> aClass, final Object o) throws SerializationException {
        final String json = new Gson().toJson(o);
        serializationVisitor.putObject("value", String.class, json);
    }

    @Override
    public TerminalColors.ColorMode deserialize(final DeserializationVisitor deserializationVisitor, final Class<TerminalColors.ColorMode> aClass, @Nullable final Object value) throws SerializationException {
