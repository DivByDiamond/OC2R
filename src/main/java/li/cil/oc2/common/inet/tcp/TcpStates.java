...
import li.cil.oc2.common.inet.tcp.state.finish.ExpiredState;
import li.cil.oc2.common.inet.tcp.state.finish.FinishState;
import li.cil.oc2.common.inet.tcp.state.finish.RejectState;
