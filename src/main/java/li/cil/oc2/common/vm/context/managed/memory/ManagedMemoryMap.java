package li.cil.oc2.common.vm.context.managed.memory;
...
public final class ManagedMemoryMap implements MemoryMap {
    private final MemoryMap memoryMap;
    private boolean isValid = true;

    public ManagedMemoryMap(final MemoryMap memoryMap) {
