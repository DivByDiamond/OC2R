...
final class ColorCompositingStage {
    static void renderProjectorColors(final Minecraft minecraft, final Matrix4f pose, final Matrix4f projectionMatrix, final int projectorCount) {
    ...
    private static void renderIntoScreenRect() {
        ...
        builder.addVertex(ProjectorDepthRenderer.MAIN_CAMERA_DEPTH.width, ProjectorDepthRenderer.MAIN_CAMERA_DEPTH.height, 0).setUv(1, 0);
