...
public final class ProjectorDepthRenderer {
    ...
    public static final List<VisibleProjector> VISIBLE_PROJECTORS = new ArrayList<>();
    public static final DepthOnlyRenderTarget[] PROJECTOR_DEPTH_TARGETS =
            new DepthOnlyRenderTarget[ModShaders.MAX_PROJECTORS];
    public static final DynamicTexture[] PROJECTOR_COLOR_TARGETS =
            new DynamicTexture[ModShaders.MAX_PROJECTORS];
    public static final Matrix4f[] PROJECTOR_CAMERA_MATRICES = new Matrix4f[ModShaders.MAX_PROJECTORS];
    public static DepthOnlyRenderTarget MAIN_CAMERA_DEPTH = null;
