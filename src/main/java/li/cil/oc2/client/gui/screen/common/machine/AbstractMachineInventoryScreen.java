...
public abstract class AbstractMachineInventoryScreen<T extends AbstractMachineTerminalContainer>
    ...
    public AbstractMachineInventoryScreen(
    ...
    protected void renderFg(
        ...
        GuiUtils.renderMissingDeviceInfoIcon(
                graphics, this, DeviceTypes.FLASH_MEMORY, Sprites.WARN_ICON);
        GuiUtils.renderMissingDeviceInfoIcon(graphics, this, DeviceTypes.MEMORY, Sprites.WARN_ICON);
        GuiUtils.renderMissingDeviceInfoIcon(
                graphics, this, DeviceTypes.HARD_DRIVE, Sprites.INFO_ICON);
    ...
    protected void renderTooltip(final GuiGraphics graphics, final int mouseX, final int mouseY) {
        ...
        GuiUtils.renderMissingDeviceInfoTooltip(
                graphics, this, mouseX, mouseY, DeviceTypes.FLASH_MEMORY);
        GuiUtils.renderMissingDeviceInfoTooltip(graphics, this, mouseX, mouseY, DeviceTypes.MEMORY);
        GuiUtils.renderMissingDeviceInfoTooltip(
                graphics, this, mouseX, mouseY, DeviceTypes.HARD_DRIVE);
