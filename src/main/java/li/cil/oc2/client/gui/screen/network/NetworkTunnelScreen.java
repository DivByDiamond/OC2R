...
public final class NetworkTunnelScreen extends AbstractModContainerScreen<NetworkTunnelContainer> {
    ...
    public NetworkTunnelScreen(
            final NetworkTunnelContainer container,
    ...
    protected void init() {
        ...
        linkButton =
                addRenderableWidget(
                                new ImageButton(
                                        leftPos + LINK_BUTTON_LEFT,
                                        topPos + LINK_BUTTON_TOP,
                                        Sprites.NETWORK_TUNNEL_LINK_BUTTON_INACTIVE.width,
                                        Sprites.NETWORK_TUNNEL_LINK_BUTTON_INACTIVE.height,
    ...
    private void createTunnel() {
        final NetworkTunnelLinkMessage message =
                new NetworkTunnelLinkMessage(getMenu().containerId);
