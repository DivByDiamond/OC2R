...
@OnlyIn(Dist.CLIENT)
public class MonitorInputCaptureButton extends ToggleImageButton {
    private final AbstractMonitorContainer menu;

    public MonitorInputCaptureButton(final int x, final int y, final AbstractMonitorContainer menu) {
        super(
                x,
                y,
                12,
