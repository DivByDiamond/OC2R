 ...
 *
 * <p>There is a default network layer implementation that uses provided {@link TransportLayer}
 * implementation (see {@link TransportLayerInternetProvider} for more information).
 */
public interface NetworkLayer extends InternetDeviceLifecycle {

    /**
     * The value of this constant should be returned by {@link
     * NetworkLayer#receivePacket(ByteBuffer)} method if no data is arrived.
     */
    short PROTOCOL_NONE = 0;

    /**
     * The value of this constant should be returned by {@link
     * NetworkLayer#receivePacket(ByteBuffer)} method if IPv4 packet is arrived.
     */
    short PROTOCOL_IPv4 = 0x0800;

    /**
     * The value of this constant should be returned by {@link
     * NetworkLayer#receivePacket(ByteBuffer)} method if any IP packet is arrived (can be either
     * IPv4 packet or IPv6 packet).
     *
     * <p>Normally, this value should be returned if any data is arrived.
     */
    short PROTOCOL_IP = PROTOCOL_IPv4;

    /**
     * The value of this constant should be returned by {@link
     * NetworkLayer#receivePacket(ByteBuffer)} method if IPv6 packet is arrived.
     */
    ...
    /**
     * Tries to get the next IP paket to wrap it into an ethernet frame and send it to virtual
     * computer later.
     *
     ...
     * @return protocol number of received data (either {@link NetworkLayer#PROTOCOL_IP}, {@link
     *     NetworkLayer#PROTOCOL_IPv4} or {@link NetworkLayer#PROTOCOL_IPv6}) or {@link
     *     NetworkLayer#PROTOCOL_NONE}, if no new data has arrived
     */
