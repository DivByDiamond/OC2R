 ...
 * LinkLocalLayerInternetProvider#provideLinkLocalLayer(LayerParameters)}.
 *
...
public abstract class LinkLocalLayerInternetProvider implements InternetProvider {
    ...
    protected static LinkLocalLayer defaultLinkLocalLayer(final LayerParameters layerParameters) {
        ...
        final NetworkLayer networkLayer =
                NetworkLayerInternetProvider.defaultNetworkLayer(networkParameters);
        return new DefaultLinkLocalLayer(layerParameters, networkLayer);
    }

    /**
     * This method is called from {@link
     * LinkLocalLayerInternetProvider#provideInternet(LayerParameters)} in order to get an {@link
     * LinkLocalLayer} implementation.
     *
    ...
    public final LinkLocalLayer provideInternet(final LayerParameters layerParameters) {
        return provideLinkLocalLayer(
                InetUtils.nextLayerParameters(layerParameters, LinkLocalLayer.LAYER_NAME));
    }
}