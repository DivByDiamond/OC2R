 ...
 * SessionLayerInternetProvider#provideSessionLayer(LayerParameters)}.
 *
...
public abstract class SessionLayerInternetProvider extends TransportLayerInternetProvider {
     ...
     * SessionLayerInternetProvider#provideTransportLayer(LayerParameters)} in order to get a {@link
     * SessionLayer} implementation. Retrieved {@link SessionLayer} implementation will be wrapped
     * with internal {@link TransportLayer} implementation.
     *
