 ...
 * Callbacks#collectMethods(Object)}.
 *
 * <p>Intended to be used in classes instances of which are used as a target of {@link
 * ObjectDevice}.
 *
...
public @interface Callback {
     ...
     *
     * <p>Note that this will lead to dramatically slower method calls as viewed from the caller as
     * each call will take at least one tick (50ms).
     *
     * <p>Use this when the targeted method interacts with data that is not thread safe, for example
     * the level or any objects inside the level, such as entities and block entities.
     *
    ...
    /**
     * Explicitly defines the name of this method. If left blank the name of the annotated method
     * will be used.
     *
