 ...
 *
 * <p>To make use of registered implementations, a flash memory item with the
...
public interface Firmware {
     ...
     *
     * <p>Typically, only returns {@code false} when there was not enough memory to fit the firmware.
     *
