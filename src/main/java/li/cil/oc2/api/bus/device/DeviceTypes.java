...
public final class DeviceTypes {
    ...
    public static final DeviceType FLASH_MEMORY =
            li.cil.oc2.common.bus.device.DeviceTypes.FLASH_MEMORY;
    public static final DeviceType CARD = li.cil.oc2.common.bus.device.DeviceTypes.CARD;
    public static final DeviceType ROBOT_MODULE =
            li.cil.oc2.common.bus.device.DeviceTypes.ROBOT_MODULE;
