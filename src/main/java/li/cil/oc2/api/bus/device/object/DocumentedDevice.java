 ...
 *
 * <p>It provides an alternative to declaring documentation to specifying the documentation directly
 * in the {@link Callback} and {@link Parameter} annotations. This may be preferable to some as it
 * reduces the visual clutter around exposed methods.
 *
 * <p>For less fragile code it is recommended to explicitly specify the callback name via {@link
 * Callback#name()} and use a constant for both the declaration and when adding documentation via
 * {@link DeviceVisitor#visitCallback(String)}. This is omitted in the example for brevity.
 *
 * <p>Example:
 *
 * <pre>
...
public interface DocumentedDevice {
     ...
     *
     * <p>The results of this method are cached.
     *
    ...
    interface DeviceVisitor {
         ...
         *
         * <p>The name must match the name of the method annotated as {@link Callback} to associate
         * the documentation provided to the returned {@link CallbackVisitor} with it. The name of
         * the method is the name explicitly specified in the {@link Callback} annotation, or the
         * name of the method, if left blank.
         *
    ...
    interface CallbackVisitor {
         ...
         *
         * <p>This corresponds to {@link Callback#description()}.
         *
         ...
         *
         * <p>This corresponds to {@link Callback#returnValueDescription()}.
         *
         ...
         *
         * <p>This will only work for parameters that have been annotated with {@link Parameter}.
         * The specified name must match that defined in the annotation, i.e. {@link
         * Parameter#value()}.
         *
         * <p>This corresponds to {@link Parameter#description()}.
         *
