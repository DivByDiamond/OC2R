 ...
 *
 * <p>For less fragile code it is recommended to explicitly specify the callback name via
...
public interface DocumentedDevice {
    ...
    interface DeviceVisitor {
         ...
         *
         * <p>The name must match the name of the method annotated as {@link Callback}
    ...
    interface CallbackVisitor {
         ...
         *
         * <p>This will only work for parameters that have been annotated with
