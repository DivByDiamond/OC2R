 ...
 * previous scan.
 *
 * <p>This is also required to avoid device duplication when a device is connected to a
 ...
 * than one face.
 *
 * <p>Providers can be registered via the provider registries, much like blocks and items
...
public interface BlockDeviceProvider {
     ...
     *
     * <p>This is the equivalent of {@link RPCDevice#dispose()} or {@link VMDevice#dispose()},
     ...
     *
     * <p>Implementing this is only necessary, if the device holds some out-of-NBT serialized
