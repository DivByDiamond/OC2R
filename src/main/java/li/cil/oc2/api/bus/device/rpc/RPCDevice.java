 ...
 *
 * <p>A {@link RPCDevice} may represent a single view onto some device, or be a
 ...
 *
 * <p>The easiest, and hence recommended, way of implementing this interface, is to use
...
public interface RPCDevice extends Device {
     ...
     *
     * <p>Device interfaces may be identified by multiple type names. Although every
     ...
     *
     * <p>In a more general sense, these can be considered tags the device can be
