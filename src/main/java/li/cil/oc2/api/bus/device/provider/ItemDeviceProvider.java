 ...
 *
 * <p>For identical queries, implementations <em>should</em> return the same device. Failing that,
 * implementations <em>should</em> return instances that are equal to each other when compared using
 ...
 *         DeferredRegister.create(ItemDeviceProvider.REGISTRY, "your_mod_id");
 *
...
public interface ItemDeviceProvider {
     ...
     *
     * <p>Return <code>0</code> if no device would be provided.
     *
     * @param query the query describing the object to get an {@link ItemDevice} for.
     ...
     * actual device.
     *
     * <p>For item devices this is rather unlikely. It means an item disappeared while the block
     * managing the item device was unloaded.
     *
